...
<<>>=
# 1: mm_tau_est 2: mm_tau_correct_est 3: mh_tau_est 4: mh_tau_correct_est 5: tau_true  6: mm_beta_est 7: mm_beta_correct_est 8: mh_beta_est 9: mh_beta_correct_est 10: beta_true
post_out[1,1,]
post_out[1,2,]
post_out[1,3,]
post_out[2,1,]
...
Moreover, by checking the plots of posterior densitiies of $\tau_j$ and $\beta_j$, we also have the same conclusion. The next step is we will apply the two methods above in analyzing RFI data. 
